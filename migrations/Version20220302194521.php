 ...
 */
final class Version20220302194521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logfile CHANGE year year INT DEFAULT 1995 NOT NULL, CHANGE month month INT DEFAULT 8 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logfile CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE filename filename VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE year year INT NOT NULL, CHANGE month month INT NOT NULL');
    }
}
